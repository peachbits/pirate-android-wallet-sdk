...
fun Arrrtoshi.toArrrString() = convertArrrtoshiToArrrString(DECIMALS, DECIMALS)
 ...
 */
/**
 * @return [zecString] parsed into Arrrtoshi or null if parsing failed.
 */
@SuppressWarnings("ReturnCount")
fun Arrrtoshi.Companion.fromZecString(
    context: Context,
    zecString: String,
    ...
    return try {
        bigDecimal.convertArrrToArrrtoshi()
