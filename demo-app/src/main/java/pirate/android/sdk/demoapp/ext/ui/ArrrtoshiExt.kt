...
package pirate.android.sdk.demoapp.ext.ui

import pirate.android.sdk.demoapp.model.CurrencyConversion
import pirate.android.sdk.demoapp.model.FiatCurrencyConversionRateState
import pirate.android.sdk.demoapp.model.Locale
import pirate.android.sdk.demoapp.model.MonetarySeparators
import pirate.android.sdk.demoapp.model.toJavaLocale
import pirate.android.sdk.ext.Conversions
...
fun Arrrtoshi.toFiatCurrencyState(
...
fun Arrrtoshi.toFiatString(
    currencyConversion: CurrencyConversion,
    locale: Locale,
    monetarySeparators: MonetarySeparators
) =
    convertArrrtoshiToZecDecimal()
...
private fun Arrrtoshi.convertArrrtoshiToZecDecimal(): BigDecimal {
    return BigDecimal(value, MathContext.DECIMAL128).divide(
        Conversions.ONE_ARRR_IN_ARRRTOSHI,
        MathContext.DECIMAL128
    ).setScale(Conversions.ARRR_FORMATTER.maximumFractionDigits, RoundingMode.HALF_EVEN)
}
