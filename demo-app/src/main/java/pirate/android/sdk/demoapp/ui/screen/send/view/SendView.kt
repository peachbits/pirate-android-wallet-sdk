package pirate.android.sdk.demoapp.ui.screen.send.view
...
private fun SendMainContent(
    ...
    Column(
        ...
        Row(Modifier.fillMaxWidth()) {
            Text(text = walletSnapshot.saplingBalance.available.toArrrString())
        }
        ...
        val zcashNetwork = PirateNetwork.fromResources(context)
        Column(
            Modifier
                .fillMaxWidth()
        ) {
