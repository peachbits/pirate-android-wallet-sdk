...
internal class PirateRustBackend private constructor(
    ...
    override suspend fun createAccount(seed: ByteArray): PirateUnifiedSpendingKey {
    ...
    override suspend fun initAccountsTable(vararg keys: PirateUnifiedFullViewingKey): Boolean {
    ...
    override suspend fun initAccountsTable(
        ...
        return PirateDerivationTool.derivePirateUnifiedFullViewingKeys(seed, network, numberOfAccounts).apply {
...
//     }
    ...
    companion object {
        ...
        @JvmStatic
        private external fun createAccount(dbDataPath: String, seed: ByteArray, networkId: Int): PirateUnifiedSpendingKey
        ...
        internal fun validatePirateUnifiedSpendingKey(bytes: ByteArray) =
