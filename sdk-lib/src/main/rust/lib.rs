...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_initOnLoad(
    _env: JNIEnv<'_>,
    _: JClass<'_>,
) {
...
fn encode_usk(
    ...
    let output = env.new_object(
        "pirate/android/sdk/model/PirateUnifiedSpendingKey",
        "(I[B)V",
        &[
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_createAccount(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    db_data: JString<'_>,
    seed: jbyteArray,
...
/// `PirateRustBackend.createAccount` for normal account creation purposes.
#[no_mangle]
...
/// the returned spending key in a secure fashion.
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_tool_PirateDerivationTool_deriveSpendingKey(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    seed: jbyteArray,
    account: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_tool_PirateDerivationTool_derivePirateUnifiedFullViewingKeysFromSeed(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    seed: jbyteArray,
    accounts: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_tool_PirateDerivationTool_derivePirateUnifiedAddressFromSeed(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    seed: jbyteArray,
    account_index: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_tool_PirateDerivationTool_derivePirateUnifiedAddressFromViewingKey(
    env: JNIEnv<'_>,
    _: JClass<'_>,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_tool_PirateDerivationTool_derivePirateUnifiedFullViewingKey(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    usk: jbyteArray,
    network_id: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_getCurrentAddress(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    db_data: JString<'_>,
    account: jint,
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_getTransparentReceiverForUnifiedAddress(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    ua: JString<'_>,
) -> jstring {
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_getSaplingReceiverForUnifiedAddress(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    ua: JString<'_>,
) -> jstring {
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_isValidSpendingKey(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    usk: jbyteArray,
) -> jboolean {
...
#[no_mangle]
pub unsafe extern "C" fn Java_pirate_android_sdk_jni_PirateRustBackend_isValidUnifiedAddress(
    env: JNIEnv<'_>,
    _: JClass<'_>,
    addr: JString<'_>,
    network_id: jint,
