    ...
    companion object {
        ...
        fun wallets(): List<Array<Any>> {
            ...
            return listOf(
                ...
                arrayOf(
                    "Sapling",
                    BlockHeight.new(PirateNetwork.Mainnet, 419_200),
                    1991772603L,
                    "76b809bb",
                    mainnetBackend
                ),
                arrayOf(
                    "Blossom",
                    BlockHeight.new(PirateNetwork.Mainnet, 653_600),
                    733220448L,
                    "2bb40e60",
                    mainnetBackend
                ),
                arrayOf(
                    "Heartwood",
                    BlockHeight.new(PirateNetwork.Mainnet, 903_000),
                    4122551051L,
                    "f5b9230b",
                    mainnetBackend
                ),
                arrayOf(
                    "Canopy",
                    BlockHeight.new(PirateNetwork.Mainnet, 1_046_400),
                    3925833126L,
                    "e9ff75a6",
                    mainnetBackend
                ),
                ...
                arrayOf(
                    "Sapling",
                    BlockHeight.new(PiratehNetwork.Testnet, 280_000),
                    1991772603L,
                    "76b809bb",
                    testnetBackend
                ),
                arrayOf(
                    "Blossom",
                    BlockHeight.new(PirateNetwork.Testnet, 584_000),
                    733220448L,
                    "2bb40e60",
                    testnetBackend
                ),
                arrayOf(
                    "Heartwood",
                    BlockHeight.new(PirateNetwork.Testnet, 903_800),
                    4122551051L,
                    "f5b9230b",
                    testnetBackend
                ),
                arrayOf(
                    "Canopy",
                    BlockHeight.new(PirateNetwork.Testnet, 1_028_500),
                    3925833126L,
                    "e9ff75a6",
                    testnetBackend
                )
