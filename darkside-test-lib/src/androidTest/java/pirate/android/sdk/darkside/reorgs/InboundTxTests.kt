...
class InboundTxTests : ScopedTest() {
    ...
    fun testLatestHeight() {
        validator.validateLatestHeight(BlockHeight.new(PirateNetwork.Mainnet, targetTxBlock.value - 1))
    }
...
//            .stageEmptyBlocks(targetHeight, overwriteBlockCount)
    ...
    companion object {
        ...
        private val firstBlock = BlockHeight.new(PirateNetwork.Mainnet, 663150L)
        private val targetTxBlock = BlockHeight.new(PirateNetwork.Mainnet, 663188L)
        ...
        fun startAllTests() {
            ...
            chainMaker
                ...
                .applyTipHeight(BlockHeight.new(PirateNetwork.Mainnet, targetTxBlock.value - 1))
